// Get the data using the URL in line 2 and 3; Assign the variables using let statements
let url = `https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson`;
let url2 = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

 // make request of the data from d3.json(url).then(function(data) {, console.log(data to check that it works)
...
function makeMap(data, data2) {
  ...
  let myMap = L.map("map", {
    ...
    zoom: 4,
    layers: [street, circleLayer, tectonicLayer, satelliteLayer]
  });
...
// Need help creating a new legend that inlcudes the color and lables of the circles to correspond to the with the magnitude
